...
outputTable = '/Users/frederictheunissen/Documents/Data/Julie/Acoustical Analysis/pairCallerCrossDiscrimResults.h5'
outputGroupedTable = '/Users/frederictheunissen/Documents/Data/Julie/Acoustical Analysis/pairCallerCrossDiscrimGroupedResults.h5'
fileExcelTable = '/Users/frederictheunissen/Documents/Data/Julie/Acoustical Analysis/pairCallerCrossDiscrimResults.xls'
    ...
    for ctypeTest in callTypeUnique:
        ...
        for fl in featureList:
            ...
            ldaY, qdaY, rfY, cvC, ldaP, qdaP, rfP, nC, ldaweights = discriminatePlot(fl['X'][testInd], birdzPair[testInd], cValBirdPair[testInd], 
                                                                                 titleStr='Caller %s (%s vs %s) 18 AF' % (ctypeTrain, gp['bird1'], gp['bird2']), 
